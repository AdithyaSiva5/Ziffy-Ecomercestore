...
//     const newPhotos = productImg.map((element) => ({ name: element.filename, path: element.path }));

//     // Combine existing and new photo paths
//     const updatedPhotos = [...existingProduct.productImg]; // Copy existing photos

//     // Add new photos to the array
//     newPhotos.forEach((newPhoto) => {
//       if (!updatedPhotos.some((existingPhoto) => existingPhoto.path === newPhoto.path)) {
